...
@section('content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="examwizard-question" action="{{ url("/siswa/absen/" . $siswa->id) }}" method="get">
                                                            <a href="#" class="btn btn-primary absen"><span data-feather="eye"></span> absen</a>
                                                        </form>
    ...
    <script>
        ...
        $(".absen").on("click",function(a){a.preventDefault(),swal({title:"Absen ?",type:"warning",showCancelButton:!0,cancelButtonText:"tidak",confirmButtonText:"ya, absen",padding:"2em"}).then(function(a){a.value&&$("#examwizard-question").submit()})});
    </script>
