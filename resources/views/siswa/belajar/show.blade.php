...
<div id="content" class="main-content">
                        ...
                        <div class="col-lg-12 exams-footer">
                            <div class="row pb-3">
                                <div class="col-sm-1 back-to-prev-question-wrapper text-center mt-3">
                                    <a href="javascript:void(0);" id="back-to-prev-question_pg" class="btn btn-primary disabled">
                                        Back
                                    </a>
                                </div>
                                ...
                                <div class="col-sm-1 go-to-next-question-wrapper text-center mt-3">
                                    <a href="javascript:void(0);" id="go-to-next-question_pg" class="btn btn-primary">
                                        Next
                                    </a>
                                </div>
                    ...
                    <form id="examwizard-question" action="#" method="POST">
                        <div class="widget shadow p-2">
                            <div class="d-flex float-right">
                                <div class="badge badge-success" style="font-size: 14px; font-weight: bold;">Tugas Sudah dikerjakan</div>
                            </div>
                            <div>
                                @php
                                    $no = 1;
    ...
    <div class="layout-px-spacing">
        ...
        @if ($waktu_ujian_essay->selesai == null)    
            <div class="row">
                <div class="col-lg-9">
                    <form id="examwizard-question_essay" action="{{ url("/siswa/ujian_essay") }}" method="POST">
                        @csrf
                ...
                <div class="col-lg-3" id="quick-access-section" class="table-responsive">
                    <div class="widget shadow p-3">
                        ...
                        <div class="widget-content">
                            ...
                            @endphp
                            @foreach ($essay_siswa as $soal)
                            <div class="question-response-rows_essay d-inline" data-question="{{ $no }}">
        ...
        @else
            <div class="row">
                <div class="col-lg-9">
                    <form id="examwizard-question_essay" action="javascript:void(0);" method="POST">
                        @csrf
                        <input type="hidden" name="kode" value="{{ $ujian_essay->kode }}">
                        <div class="widget shadow p-2">
                            <div class="d-flex float-right">
