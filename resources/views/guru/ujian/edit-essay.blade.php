...
@section('content')
    ...
    <div id="content" class="main-content">
        <a href="javascript:void(0);" class="btn btn-primary tambah-essay"
            style="position: fixed; right: -10px; top: 50%; z-index: 9999;">Edit Soal</a>
        <div class="layout-px-spacing">
            <form action="{{ url('/guru/ujian_essay_update/'.$tugas->kode) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row layout-top-spacing">
                    <div class="col-lg-12 layout-spacing">
                        <div class="widget shadow p-3">
                            <div class="widget-heading">
                                <h5 class="">Tugas Essay</h5>
                                <div class="row mt-2">
                                    <div class="col-lg-4">
