<script>
    $(".question-response-rows").click(function(){var e=$(this).data("question"),n=".question-"+e;$(".question").addClass("hidden"),$(n).removeClass("hidden"),$("input[name=currentQuestionNumber]").val(e),$("#current-question-number-label").text(e),$("#back-to-prev-question_pg").removeClass("disabled"),$("#go-to-next-question_pg").removeClass("disabled")});var examWizard=$.fn.examWizard({finishOption:{enableModal:!0}});
    ...
    @if ($waktu_ujian->selesai == null)
        ...
        $("#go-to-next-question_pg").click(function(){var n=$("input[name=currentQuestionNumber]").val(),a=parseInt(n)+parseInt(1),n="ragus-"+a;a<="{{ $ujian->detailujian->count() }}"&&($(".ragus").addClass("hidden"),$("."+n).removeClass("hidden"))});

        $("#back-to-prev-question_pg").click(function(){var e=$("input[name=currentQuestionNumber]").val(),a=parseInt(e)-parseInt(1),e="ragus-"+a;0!=a&&($(".ragus").addClass("hidden"),$("."+e).removeClass("hidden"))});
