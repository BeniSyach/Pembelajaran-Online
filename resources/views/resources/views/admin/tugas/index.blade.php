                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="widget-heading">
                                    <h5 class="">Tugas</h5>
                                    <a href="{{ url("/admin/tugas/create") }}" class="btn btn-primary btn-sm mt-3"><span data-feather="book"></span> Tambah Tugas</a>
                                </div>
                                    ...
                                    <table id="datatable-table" class="table text-center text-nowrap">
                                        ...
                                        <tbody>
                                            @foreach ($km_tugas as $t)
                                                <tr>
                                                    <td>{{ $t->nama_tugas; }}</td>
                                                    {{-- <td>{{ $t->sesi->nama_tugas; }}</td> --}}
                                                    <td>
                                                        <a href="{{ url("/admin/tugas/" . $t->kode) }}" class="btn btn-primary btn-sm"><span data-feather="eye"></span></a>
                                                        <a href="{{ url("/admin/tugas/" . $t->kode . "/edit") }}" class="btn btn-success btn-sm"><span data-feather="edit"></span></a>
                                                        <form action="{{ url("/admin/tugas/" . $t->kode) }}" method="post" class="d-inline" id="formHapus">
                                                            @csrf
                                                            @method('DELETE')
